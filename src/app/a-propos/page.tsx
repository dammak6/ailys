    ...
    <div className="w-full bg-ailys-bone text-ailys-black">
      ...
      <section className="relative w-full min-h-[50vh] sm:min-h-[60vh] flex items-end bg-ailys-black text-ailys-bone pb-16 pt-32 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="https://kafyatqatggifedqtctm.supabase.co/storage/v1/object/public/media/editorial/11_ailys_atmosphere.webp"
            alt="Campagne AÏLYS"
            fill
            priority
            sizes="100vw"
        ...
        <Container size="xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="relative aspect-[4/5] w-full overflow-hidden bg-ailys-bone-dark border border-ailys-bone-border">
              <Image
                src="https://kafyatqatggifedqtctm.supabase.co/storage/v1/object/public/media/editorial/10_the_close_up.webp"
                alt="Portrait AÏLYS"
                fill
